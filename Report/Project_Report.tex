...
\begin{multicols}{3}
	...
	\begin{mdframed}
		\textbf{1/(delay.area)(ns-1.um-2):} \\\\66.5516E-12\\\\
	\end{mdframed}
...
\begin{center}
    \begin{tabular}{ | l | p{10cm} |}
    	...
    	README.txt & contains clock name and top module name \\ \hline
    	HistEq.v & Contains all verilog modules required for synthesis\\ \hline
    	HistEq\_tb.v & Contains Testbench and SRAM modules\\ \hline
    	setup.tcl & Synopsys TCL file for configuring clock \\ \hline
    	read.tcl & Synopsys TCL File \\ \hline
    	Constraints.tcl & configures constraints required for synthesis \\ \hline
    	CompileAnalyze.tcl & Compiles for synthesis and outputs synthesis results \\ \hline
    	command.log & shows all commands run for synthesis\\ \hline
    	timing\_max\_slow.rpt & used to verify slow timing is met\\ \hline
    	timing\_min\_fast\_holdcheck\_tut1.rpt & checks that hold time is met when running fast\\ \hline
    	timing\_max\_slow\_holdfixed\_tut1.rpt & checks slow path after hold violation is fixed\\ \hline
    	cell\_report\_final.rpt & reports size of full area\\ \hline
